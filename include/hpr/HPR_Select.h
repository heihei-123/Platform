 ...
 */
HPR_DECLARE HPR_INT32 CALLBACK HPR_Select
(HPR_INT32 iMaxFd, fd_set* fdset_r, fd_set* fdset_w, fd_set* fdset_e, struct timeval* tv); 
 ...
 * return  the same meaning in select
 */
HPR_DECLARE HPR_INT32 CALLBACK HPR_SelectEx
(HPR_INT32 iMaxFd, fd_set* fdset_r, fd_set* fdset_w, fd_set* fdset_e, struct timeval* tv);
