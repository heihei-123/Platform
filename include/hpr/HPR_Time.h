 ...
 * @sa HPR_GetTimeTick
 */
HPR_DECLARE HPR_TIME_T CALLBACK HPR_TimeNow(HPR_VOID);
 ...
 * @sa HPR_TimeNow
 */
HPR_DECLARE HPR_UINT32 CALLBACK HPR_GetTimeTick(HPR_VOID);

/**
 * @fn:    HPR_GetTimeTickSecs \n
 * @brief: 获取系统启动后的经过的秒\n
 * @param[in]  N/A
 * @return: 获取系统启动后的经过的秒\n  
 */
HPR_DECLARE HPR_UINT32 CALLBACK HPR_GetTimeTickSecs(HPR_VOID);
 ...
 */
HPR_DECLARE HPR_TIME_T CALLBACK HPR_TimeFromAnsiTime(time_t tAnsiTime);
 ...
 */
HPR_DECLARE time_t CALLBACK HPR_AnsiTimeFromTime(HPR_TIME_T iTime);
