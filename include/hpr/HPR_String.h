...
HPR_DECLARE char* CALLBACK HPR_Strdup(const char* str);

HPR_DECLARE char* CALLBACK HPR_Strndup(const char* s,  int n);

HPR_DECLARE int CALLBACK HPR_Strlen(const char* s1);
