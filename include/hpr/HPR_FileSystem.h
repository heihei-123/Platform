...
#define HPR_SYNC		0x1000		/**< */
#define HPR_DSYNC       0x2000
...
#if 0
/*
* @fn HPR_DECLARE HPR_INT32 HPR_Statfs64(const HPR_INT8 pcPath, struct statfs *pstruBuf)
* @brief 查询文件系统相关的信息 (64位接口)  
* @param pcPath(in)    设备挂载路径
* @param pstruBuf(out) 文件系统信息
* @return HPR_ERROR  失败
* @return HPR_OK    成功
*/
///TODO:在HISI平台已经测试通过，其他平台还未进行测试
HPR_DECLARE HPR_INT32 HPR_Statfs64(const HPR_INT8 *pcPath, struct statfs *pstruBuf);
#endif
