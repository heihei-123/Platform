...
#define HLOG_HANLDE_MODULE(module) \
    static HLOG_HANDLE HLOGCAT(hlog_handle_, module) = hlog_OpenLoggerA(HLOGSTR(module)); 

#define HLOGGER(module) HLOGCAT(hlog_handle_, module)

#ifndef DISABLE_DEFAULT_LOG
#define DISABLE_DEFAULT_LOG

HLOG_HANLDE_MODULE(default) 
HLOG_HANLDE_MODULE(HPP) 
HLOG_HANLDE_MODULE(MQ)
